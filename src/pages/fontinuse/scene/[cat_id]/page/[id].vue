...
let _params = ref(`scene=${_cat_id}&per_page=${_perPage}&page=${_current}&context=embed`)
...
<section class="sec_fontinuse sec">
    <div class="sec__inner">
      <div class="page__header">
        ...
        <Select type="fontinuse" taxtype="scene" :catid="_cat_id" v-model="catName" />
      </div>
      <div v-if="_posts">
    ...
    <Pagination :numPages="_numPage" :current="_current" :total="_limit" :urlSlug="`${_postType}/scene/${_cat_id}`" />
  </section>
</template>
