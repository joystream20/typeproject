...
let _params = ref(`story_category=${_cat_id}&per_page=${_perPage}&page=${_current}&context=embed`)
...
<section class="sec_story sec">
    <div class="sec__inner">
      <div class="page__header">
        ...
        <Select type="story" taxtype="story_category" :catid="_cat_id" v-model="catName" />
      </div>
      <div v-if="_posts">
