...
const fetchData = async () => {
  ...
  useHead({
    title:`${t('story')} | ${config.public.siteTitle}`
  })
onMounted(() => {
  stClass.value = {type:"archive",cls:"story",lng:locale.value}
  // _totalNum.value = _story.value[0].allPostsNum
  // console.log(_posts)
  fetchData();
})
</script>
