...
let _params = ref(`interview_category=${_id}&per_page=${_perPage}&page=${_current}&context=embed`)
...
<section class="sec_interviews sec">
    <div class="sec__inner">
      <div class="page__header">
        ...
        <Select type="interviews" taxtype="interview_category" :catid="_id" v-model="catName" />
      </div>
      <div v-if="_posts">
    ...
    <Pagination :numPages="_numPage" :current="_current" :total="_limit" :urlSlug="`${_postType}/category/${_id}`" />
  </section>
</template>
