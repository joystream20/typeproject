...
// const _numPage:number = config.public.pagerNumPage

// const _totalNum = ref<number>(0)
...
// const {data: _interviews, status:_status_interview, error:_error_interview} = await useFetch<Post[]>(`${langApi}/interviews?context=embed`)
// if (_error_interview.value) {
//     console.error('Error fetching data:', _error_interview.value);
//   } else {
