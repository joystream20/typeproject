...
<section class="sec_interviews sec">
    <div class="sec__inner">
      <div class="page__header">
        ...
        <Select type="interviews" taxtype="font_type" :catid="_cat_id" v-model="catName" />
      </div>
      <div v-if="_posts">
    ...
    <Pagination :numPages="_numPage" :current="_current" :total="_limit" :urlSlug="`${_postType}/font-type/${_cat_id}`" />
  </section>
</template>
